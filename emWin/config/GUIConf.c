...
//----------------------------------------------------------------------
// if you want to rotate the screen in Landscape Mode :
// you must use external ram as GUI-Ram
//----------------------------------------------------------------------
//#define  USE_SDRAM_AS_GUIMEM    1   // use external ram as GUI RAM (slow)
#define  USE_SDRAM_AS_GUIMEM    0   // use internal ram as GUI RAM (fast)
...
#if USE_SDRAM_AS_GUIMEM==1
  // UB : "HeapMemSection" musst be defined in Linker-Script
